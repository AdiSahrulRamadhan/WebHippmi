        ...
        <main class="content-body">
            ...
            <?php if ($action === 'index'): ?>
                ...
                <div class="panel">
                    ...
                    <div class="filter-bar">
                     ...
                     <!-- Table Data -->
                     <form id="bulkDeleteForm" method="post" action="kegiatan.php?action=bulk_delete">
            ...
            <?php elseif (in_array($action, ['create', 'edit'], true)): ?>
                ...
                <div class="panel">
                    ...
                    <form method="post" action="kegiatan.php?action=<?= $action; ?><?= $action === 'edit' ? '&id=' . $id : ''; ?>" enctype="multipart/form-data">
                        <div class="form-grid">
