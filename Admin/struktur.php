...
?>
<style>.gambar-utama-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:20px;padding:22px 26px}@media(max-width:768px){.gambar-utama-grid{grid-template-columns:1fr;padding:16px;gap:16px}.gambar-utama-grid .image-preview-container{height:200px !important;max-height:200px !important}.gambar-utama-grid .image-preview-container img{height:200px !important;max-height:200px !important}.gambar-utama-panel .panel-header{flex-direction:column;align-items:stretch;gap:12px}.gambar-utama-panel .panel-header a{width:100%;justify-content:center}}</style>
<div class="panel gambar-utama-panel" style="border:1px solid #e6e6ec;">
